...
public class BuscaEntidade extends javax.swing.JFrame {

    /**
     * Creates new form BuscaEntidade
     */
    public BuscaEntidade() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nome", "Responsavel", "Cnpj", "Cpf" }));
       ...
       private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedIndex() ==  0){
            db.getEntidadesbyNome(this.jTextField1.getText());
            this.dispose();
        }else if (jComboBox1.getSelectedIndex() ==  3){
            db.getEntidadesbyCpf(this.jTextField1.getText());
            this.dispose();
        }else if (jComboBox1.getSelectedIndex() ==  2){
            db.getEntidadesbyCnpj(this.jTextField1.getText());
            this.dispose();
        }else if (jComboBox1.getSelectedIndex() ==  1){
            db.getEntidadesbyResponsavel(this.jTextField1.getText());
            this.dispose();
        }
